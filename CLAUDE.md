...
- Цена: 500–1000 ₽/мес
- **Сайт — первичен, бот — служебный.** Репетитор живёт в веб-кабинете (регистрация, ученики, расписание). Бот = доставка напоминаний ученикам + кнопки «Буду/Отменяю». У ученика — только бот, ничего лишнего.
